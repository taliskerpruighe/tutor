...
*The permission modes there are* set five modes on the table, and the
Boss settled on one for his own baseline. Not default, and not accept
edits — auto, set once in his global settings, and left there.
