...
*The boss recommends: auto mode* was the last recommendation, and it
is a baseline — set once, left running underneath everything. Plan
mode is not that. It is a mode you reach for on purpose, for a
