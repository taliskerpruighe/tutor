...
rather than letting the session simply end and the gap go unremarked.
...
The next pair watches something that has nothing to do with a tool
call at all — where the agent is sitting, and what that means it has
already read.
