...
*Why Claude Code* made the local-and-visible arrangement sound like a
...
about which is which. The case in *Why Claude Code* was privacy:
nothing leaves your machine that you did not send. This article's
case is capability: the same standing-inside-your-files arrangement
also means there is more of your machine for it to use. Both are true
at once, and neither depends on the other.
