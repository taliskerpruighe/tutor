...
than *What a workflow is* being enough on its own.
...
around each spawn adds overhead a chain does not carry, and that
...
which job you are looking at before you reach for one.
