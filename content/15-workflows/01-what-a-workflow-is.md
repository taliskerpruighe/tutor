...
machine. It sits in `.claude`, alongside what you built in Agents and
Skills, and it can see everything a session in that folder can see —
the same custom agents, the same skills, called by name the same way an
