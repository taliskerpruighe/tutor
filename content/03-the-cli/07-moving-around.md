...
That is The CLI — the prompt, the program that reads it, and enough
addresses and commands to get anywhere on the machine. Software is next:
what the apps you have paid for are actually made of, where the pieces
come from, and the one program that fetches them for you.
