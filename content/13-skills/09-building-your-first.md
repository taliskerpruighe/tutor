...
**`high` does everything else.** The setting for work that does not fit
`medium` or `xhigh`, and where most of your skills will sit. If you
are hesitating between two rows, take this one.
