...
belongs in a supporting file instead — the subject of *Supporting
files*.
...
That conversation is the whole of *Building your first skill*. The
body is where your way of working goes, and getting it in there is a
matter of describing your job to something that already knows how to
write it down.
