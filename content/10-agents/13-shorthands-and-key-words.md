...
The next article is the same idea turned toward judgement rather than
substitution: a second model, watching the first, and a setting of its
own that deserves the same deliberate hand.
