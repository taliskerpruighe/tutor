...
the fetch, push and pull from the last article, aimed at one particular
remote.
...
The next article is a different tool that reads the exact same history
GitHub hosts, handling two of git's oldest habits differently.
