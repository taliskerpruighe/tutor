...
about the model from the last three articles changes: commits, branches
and remotes all mean exactly what they meant there. What changes is the
handling — two of git's oldest sharp edges are simply not present.
...
The next article is what a coding harness gets out of any of this being
true at all.
