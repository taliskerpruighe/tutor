...
weeks ago and it may simply no longer be there. Git keeps the whole
...
The next article is the model underneath git itself — what a commit
actually chains into, and what a branch splits off.
