...
Do not trust what comes back from the last article's ask. Left to
itself, Claude will sell you ten times the agents you actually need,
...
checking before you let it run unattended. Hooks are next: the one
piece of this course that can force an agent's hand rather than merely
asking for it, and the way you keep watching a pipeline once it has
grown too large to read by eye.
