...
Not every counter-recommendation in this part rules out its subject
outright. The next one sounds like exactly what a chain needs — several
agents working the same job together — and it is the one on this list
