...
Read the official documentation on this, or simply ask Claude, and
you get the same tidy answer both times. It is all about the
...
anyway. Just do not treat them as the mechanism. Treat them as a
hint that may or may not be taken.

The mechanism is something else, and the Boss is happy to report it
is one keystroke. Next article.
