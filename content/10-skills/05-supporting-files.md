...
That is the shape of a skill: a folder, a `SKILL.md` with four
settings and a body, and up to three folders of material beside it.
Next is how you actually get one built — starting, as it turns out,
with examples rather than instructions.
