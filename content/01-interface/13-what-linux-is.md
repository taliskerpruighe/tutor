...
Here is the fact worth keeping. Linux runs on under three percent of
desktops and on the overwhelming majority of servers.

Every website you loaded today was served by it. So was the machine that
routed your email, whoever hosts it. And Claude Code: your Mac runs the
harness, but the model you are talking to runs on a machine in a data
centre, and that machine is running Linux. You have been talking to it
for weeks without meeting it.

> The article on your shell already placed Linux in the family tree:
> your Mac is a certified Unix descendant, and Linux is an independent
> rebuild of the same design, done in the open. Related, not identical.
