...
*What a harness is* defined **harness** and then named exactly one.
That was not the whole picture — it was the one this course teaches.
Here is what else answers to the word.
